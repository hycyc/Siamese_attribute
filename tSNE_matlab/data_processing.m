...
% fprintf('%d\n',5);
siamese811_pred = load('../data/model_Siameseprediction.mat');
siamese811_pred = squeeze(siamese811_pred.data);
y_label = load('../data/model_Siamesegroundtruth.mat');
y_label = y_label.data;
fprintf('%d\n', 0);
siamese811X = tsne(siamese811_pred);
save Siamese811.mat;
fprintf('%d\n',1);